...
public class ConsumeMessageConcurrentlyService implements ConsumeMessageService {
    ...
    public void processConsumeResult(
        ...
        switch (status) {
            ...
            case CONSUME_SUCCESS: //ackIndex = context.getAckIndex()
        ...
        switch (this.defaultMQPushConsumer.getMessageModel()) {
            ...
            case CLUSTERING:
                ...
                //如果发回 Broker 成功，结果因为例如网络异常，导致 Consumer以为发回失败
                // 判定消费发回失败，会导致消息重复消费，因此，消息消费要尽最大可能性实现幂等性
    ...
    private void submitConsumeRequestLater(
        ...
        System.out.println("【消费者提交延迟消费请求】");
    ...
    class ConsumeRequest implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                //原始 Topic 为 TopicTest，重试时 Topic 为 %RETRY%please_rename_unique_group_name_4，经过该方法，Topic 设置回 TopicTest
                ...
                System.out.println("【消费者回调接口消费消息,返回值是】"+status);
            } catch (Throwable e) {
            ...
            // 处理消费结果
            //这里有个漏洞 处理消费结果。如果消费处理队列被移除，恰好消息被消费，则可能导致消息重复消费，因此，消息消费要尽最大可能性实现幂等性
