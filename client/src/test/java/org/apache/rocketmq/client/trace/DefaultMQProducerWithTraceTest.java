...
public class DefaultMQProducerWithTraceTest {
    ...
    public void init() throws Exception {
        ...
        producer.getDefaultMQProducerImpl().getMqClientInstance().registerProducer(producerGroupTemp, producer.getDefaultMQProducerImpl());
    ...
    public void testSendMessageSync_WithTrace_Success() throws RemotingException, InterruptedException, MQBrokerException, MQClientException {
        traceProducer.getDefaultMQProducerImpl().getMqClientInstance().registerProducer(producerGroupTraceTemp, traceProducer.getDefaultMQProducerImpl());
